...
(function() {
    ...
    CashboxDiagram.prototype.calculateLayout = function(nodes, level, parentX, parentY) {
        ...
        nodes.forEach(function(node, index) {
            ...
            if (index < nodes.length - 1) {
                totalWidth += self.options.horizontalSpacing;
            }
        });
        ...
        nodes.forEach(function(node, index) {
            ...
            currentX += subtreeWidth + self.options.horizontalSpacing;
        });
    ...
    CashboxDiagram.prototype.drawConnector = function(x1, y1, x2, y2, isRefund) {
    ...
    CashboxDiagram.prototype.createNodeElement = function(node, x, y) {
        ...
        amount.style.cssText = 'font-weight: 700; font-size: 16px; color: #198754;';
        amount.textContent = self.formatMoney(node.amount) + ' €';

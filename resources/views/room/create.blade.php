{{ Form::open(['url' => 'room', 'method' => 'post', 'class' => 'needs-validation', 'novalidate']) }}
    ...
    <div class="row">
            ...
            <div class="form-group">
                ...
                <div class="d-flex flex-column gap-2">
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="payment-worker">{{ __('Платит сам') }}</label>
                    </div>
                    <div class="form-check">
                        <input type="radio" name="payment_type" value="agency" class="form-check-input" id="payment-agency">
                        <label class="form-check-label" for="payment-agency">{{ __('Платит агенство') }}</label>
                    </div>
                    <div class="form-check">
                        <input type="radio" name="payment_type" value="partial" class="form-check-input" id="payment-partial">
                        <label class="form-check-label" for="payment-partial">{{ __('Платит частично') }}</label>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-12" id="partial-amount-container" style="display: none;">
            <div class="form-group">
                ...
                <div class="input-group">
                    {{ Form::number('partial_amount', null, ['class' => 'form-control', 'placeholder' => __('Сумма'), 'step' => '0.01', 'min' => 0, 'id' => 'partial-amount-input']) }}
                    <span class="input-group-text">€</span>
                </div>

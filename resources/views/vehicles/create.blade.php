...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{ __('Добавить') }}</li>
@endsection
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {{ Form::text('license_plate', null, ['class' => 'form-control', 'required' => true, 'placeholder' => __('Например: 1A2 3456')]) }}
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <x-required></x-required>
                                {{ Form::text('brand', null, ['class' => 'form-control', 'required' => true, 'placeholder' => __('Например: Škoda Octavia')]) }}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {{ Form::text('color', null, ['class' => 'form-control', 'placeholder' => __('Например: Белый')]) }}
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                {{ Form::label('vin_code', __('VIN-код'), ['class' => 'form-label']) }}
                                {{ Form::text('vin_code', null, ['class' => 'form-control', 'maxlength' => 17, 'placeholder' => __('17 символов')]) }}
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                {{ Form::label('fuel_consumption', __('Расход топлива (л/100км)'), ['class' => 'form-label']) }}
                                {{ Form::number('fuel_consumption', null, ['class' => 'form-control', 'step' => '0.1', 'min' => '0', 'max' => '99.9', 'placeholder' => '7.5']) }}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <small class="text-muted">{{ __('JPG, PNG или WebP. Максимум 5MB.') }}</small>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {{ Form::select('assigned_type', ['' => __('Не назначен'), 'worker' => __('Работник'), 'user' => __('Пользователь')], null, ['class' => 'form-control', 'id' => 'assigned_type']) }}
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <select name="assigned_id" id="assigned_id" class="form-control" disabled>
                                    <option value="">{{ __('Сначала выберите тип') }}</option>
                                </select>
                            </div>
                        </div>
                    </div>
